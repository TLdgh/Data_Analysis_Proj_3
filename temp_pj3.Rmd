...
```{r}
FilterByTime <- function(df, start_time, end_time, interval_minutes) {
...
BASA_SummerWeekday <- FilterByTime(BASA_WEEKDAY_SUMMER, start_time = "00:00:00", end_time = "24:00:00", 240)

ZeroFour_BASA_WEEKDAY_SUMMER <- BASA_SummerWeekday[["00:00:00_04:00:00"]]
FourEight_BASA_WEEKDAY_SUMMER <- BASA_SummerWeekday[["04:00:00_08:00:00"]]
EightTwelve_BASA_WEEKDAY_SUMMER <- BASA_SummerWeekday[["08:00:00_12:00:00"]]
TwelveSixteen_BASA_WEEKDAY_SUMMER <- BASA_SummerWeekday[["12:00:00_16:00:00"]]
SixteenTwenty_BASA_WEEKDAY_SUMMER <- BASA_SummerWeekday[["16:00:00_20:00:00"]]
TwentyTwentyfour_BASA_WEEKDAY_SUMMER <- BASA_SummerWeekday[["20:00:00_24:00:00"]]
```

```{r}
# group by interval = 4 hours for BASA autumn weekday
BASA_AutumnWeekday <- FilterByTime(BASA_WEEKDAY_AUTUMN, start_time = "00:00:00", end_time = "24:00:00", 240)

ZeroFour_BASA_WEEKDAY_AUTUMN <- BASA_AutumnWeekday[["00:00:00_04:00:00"]]
FourEight_BASA_WEEKDAY_AUTUMN <- BASA_AutumnWeekday[["04:00:00_08:00:00"]]
EightTwelve_BASA_WEEKDAY_AUTUMN <- BASA_AutumnWeekday[["08:00:00_12:00:00"]]
TwelveSixteen_BASA_WEEKDAY_AUTUMN <- BASA_AutumnWeekday[["12:00:00_16:00:00"]]
SixteenTwenty_BASA_WEEKDAY_AUTUMN <- BASA_AutumnWeekday[["16:00:00_20:00:00"]]
TwentyTwentyfour_BASA_WEEKDAY_AUTUMN <- BASA_AutumnWeekday[["20:00:00_24:00:00"]]
```

```{r}
# group by interval = 4 hours for BASA summer weekend
BASA_SummerWeekend <- FilterByTime(BASA_WEEKEND_SUMMER, start_time = "00:00:00", end_time = "24:00:00", 240)

ZeroFour_BASA_WEEKEND_SUMMER <- BASA_SummerWeekend[["00:00:00_04:00:00"]]
FourEight_BASA_WEEKEND_SUMMER <- BASA_SummerWeekend[["04:00:00_08:00:00"]]
EightTwelve_BASA_WEEKEND_SUMMER <- BASA_SummerWeekend[["08:00:00_12:00:00"]]
TwelveSixteen_BASA_WEEKEND_SUMMER <- BASA_SummerWeekend[["12:00:00_16:00:00"]]
SixteenTwenty_BASA_WEEKEND_SUMMER <- BASA_SummerWeekend[["16:00:00_20:00:00"]]
TwentyTwentyfour_BASA_WEEKEND_SUMMER <- BASA_SummerWeekend[["20:00:00_24:00:00"]]
```

```{r}
# group by interval = 4 hours for BASA autumn weekend
BASA_AutumnWeekend <- FilterByTime(BASA_WEEKEND_AUTUMN, start_time = "00:00:00", end_time = "24:00:00", 240)

ZeroFour_BASA_WEEKEND_AUTUMN <- BASA_AutumnWeekend[["00:00:00_04:00:00"]]
FourEight_BASA_WEEKEND_AUTUMN <- BASA_AutumnWeekend[["04:00:00_08:00:00"]]
EightTwelve_BASA_WEEKEND_AUTUMN <- BASA_AutumnWeekend[["08:00:00_12:00:00"]]
TwelveSixteen_BASA_WEEKEND_AUTUMN <- BASA_AutumnWeekend[["12:00:00_16:00:00"]]
SixteenTwenty_BASA_WEEKEND_AUTUMN <- BASA_AutumnWeekend[["16:00:00_20:00:00"]]
TwentyTwentyfour_BASA_WEEKEND_AUTUMN <- BASA_AutumnWeekend[["20:00:00_24:00:00"]]
```